...
public class TransformationsMapAndReduce {
    ...
    public void yourFirstTransformationWithMap() throws IOException {
        ...
        Function<Person, PersonDTO> personPersonDTO = person ->
                new PersonDTO(
                        person.getId(),
                        person.getFirstName(),
                        person.getAge());
        ...
        List<PersonDTO> dtos = people.stream()
                ...
                .map(PersonDTO::map)   // or we can use the function above  .map(personPersonDTO)
    ...
    @Test
    public void mapToDoubleAndFindAverageCarPrice() throws Exception{
