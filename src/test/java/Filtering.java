...
public class Filtering {
    ...
    public void dropWhile() throws Exception {
        ...
        Stream.of(2,4,6,8,10,12).filter(n -> n%2 == 0)
                .forEach(n -> System.out.print(n + " "));
        System.out.println();
        // drop elements while the predicate is true, so from the number 11 the numbers are not dropped
        System.out.println("using dropWhile");
        Stream.of(2,4,6,8,10,11,12).dropWhile(n -> n%2 ==0)
                .forEach(n -> System.out.print(n + " "));
    }
    ...
    public void takeWhile() throws Exception {
        ...
        Stream.of(2,4,6,8,10,11,12).takeWhile(n -> n%2 ==0)
                .forEach(n -> System.out.print(n + " "));
    }
